...
Some clickable components (like text boxes and radio buttons) keep focus even after they are clicked. In the case of text boxes, this is for the user to pass key information to the component after the box has been selected by the clicking. In rare cases, components must perform an action when they lose focus.
