...
public class Example6 extends JPanel implements Container, MouseListener, KeyListener, MouseMotionListener, MouseWheelListener{
	private Manager6 manager = null;
	...
	public Example6(){
		JFrame frame = new JFrame("Example 6");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.add(this);
		manager = new Manager6(this);
		manager.createMenu();
		frame.pack();
	...
	private void run() {
		//We have the flower button animation to accomodate for
		final int FRAME_PER_MS = 250;
		long currentTime;
