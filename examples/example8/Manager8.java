...
public class Manager8 extends MenuManager {
	...
	public void createMenu() {
		...
		addTouchResponsiveComponent(new Button("", "A", vp2, 0, 0, font, Color.CYAN));
		...
		addTouchResponsiveComponent(C);
		addTouchResponsiveComponent(new Button("", "D", vp2, 1, 1, font, Color.PINK));
		/*
		addTouchResponsiveComponent(new Button("", "B", vp2, 1, 0, font, Color.BLUE));
		addTouchResponsiveComponent(new Button("", "C", vp2, 0, 1, font, Color.MAGENTA));
		addTouchResponsiveComponent(new Button("", "D", vp2, 1, 1, font, Color.PINK));
		*/
		
		//add a centered button in b
		new Button("centered", "Centered!", B, "CENTERX", "CENTERY", "width/3", "height/3", font, Color.YELLOW);
