...
public class Example5 extends JPanel implements Container, MouseListener, KeyListener, MouseMotionListener, MouseWheelListener{
	private static final long serialVersionUID = 1L;
	private Manager5 manager = null;
	...
	public Example5(){
		frame = new JFrame("Example 5");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.add(this);
		manager = new Manager5(this);
		manager.createMenu();
		frame.pack();
