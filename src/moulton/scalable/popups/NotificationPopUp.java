...
/**
 * This is an example of what can be done with pop ups. Sometimes the user needs to be notified of
 * some event or information before they proceed to the next action, and this pop up fulfills this
 * purpose. The constructor calls an init method that creates the contents of the pop up on its
 * base panel.
...
public class NotificationPopUp extends CommonPopUp {
	 ...
	 */
	public NotificationPopUp(String text, String title, Font font, String xId,
			MenuManager manager) {
	 ...
	 * @param manager the menu manager that contains this pop up. This is used to exit out.
	 */
	public NotificationPopUp(String text, String title, Font font, String x, String y,
			String xId, MenuManager manager) {
		super(text, title, font, xId, manager);
		init(xId, font, manager);
	}
